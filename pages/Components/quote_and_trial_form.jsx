        ...
        <>
            <div id={ServiceCss.form_of_upload}>
                    ...
                    <form action="">
                                    ...
                                    <label htmlFor="" className='mt-4'>Instruction</label>
                                    <textarea name="" id="" cols="30" rows="10" className='form-control' placeholder='Type Here . . . '></textarea>
...
export default quote_and_trial_form