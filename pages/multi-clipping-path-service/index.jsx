...
export async function getServerSideProps () {
    const response = await fetch("https://clipping-path-website-final.vercel.app/api/services/multi-clipping-path-service")
...
const Services = ({ data }) => {
    ...
    return(
        <>
            ...
            <Head>   
                <title>Multi-Clipping Path Service</title>
